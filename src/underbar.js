...
(function() {
   ...
   * of values; in JavaScript, a 'collection' is something that can contain au
  ...
  _.invoke = function(collection, methodName, args) {
	return _.map(collection,function(element){
		return (typeof methodName === "function" ? methodName : element[methodName]).apply(element,args);
	});
  }
  ...
  _.every = function(collection, iterator) {
    return _.reduce(collection, function(all, item) {
		if(!all) return false;
		return iterator? (iterator(item)? true : false) : item
	},true)
  };
